function processQuestionnaire() {
    ...
    // Loop through the questions array
          ...
          swal("โปรดเลือกข้อคำถามให้ครบ", "", "error");
            ...
            if (score <= 7 ) {
                swal("ไม่มีความเสี่ยงของอาการของโรคซึมเศร้า","มีอาการของโรคซึมเศร้าระดับน้อยมาก","success");
            } 
            else if (score <= 12)
            {
                swal("เสี่ยงที่จะมีอาการของโรคซึมเศร้า ระดับน้อย","ควรพบแพทย์เพื่อประเมินอาการและให้การรักษา","success");
            }
            else if(score <=18)
            {
                swal("เสี่ยงที่จะมีอาการของโรคซึมเศร้า ระดับปานกลาง","ควรพบแพทย์เพื่อประเมินอาการและให้การรักษา","success");
            }
  
            else {
                swal("เสี่ยงที่จะมีอาการของโรคซึมเศร้า ระดับรุนแรง","ต้องพบแพทย์เพื่อประเมินอาการและให้การรักษาโดยเร็ว ไม่ควรปล่อยทิ้งไว้","success");
            }
            document.getElementById("processQuestionnaire").innerHTML = "thankyou";
          }
